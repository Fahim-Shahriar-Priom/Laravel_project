    ...
    <nav class="navbar navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="{{route('home.index')}}">TechBD</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
								<li><a href="{{route('Order.PendingOrder')}}">Pending Orders</a></li>
								<li><a href="{{route('Order.DeliveredOrder')}}">Delivered Orders</a></li>
              </ul>
            </li>
          </ul>
          ...
          <ul class="nav navbar-nav navbar-right">
					<li><a href="{{route('Admin.showUser')}}" style="text-decoration:none;">Users</a></li>
